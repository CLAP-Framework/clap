...
//  ROS_DEBUG("[driver] Publishing a full rslidar scan.");
  ...
  //node_status_pub_ptr_->CHECK_RATE("rslidar_packets", 8, 5, 1, "topic 'rslidar_packets' publish rate low.");      
...
//    ROS_DEBUG("[driver] Publishing a difop data.");
	...
	//node_status_pub_ptr_->NODE_ACTIVATE();
	//node_status_pub_ptr_->CHECK_RATE("rslidar_packets_difop", 8, 5, 1, "topic 'rslidar_packets_difop' publish rate low.");      
