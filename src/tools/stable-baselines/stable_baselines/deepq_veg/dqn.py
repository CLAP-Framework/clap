...
from stable_baselines.deepq_veg.build_graph import build_train
from stable_baselines.deepq_veg.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from stable_baselines.deepq_veg.policies import DQNPolicy
from stable_baselines.a2c.utils import total_episode_reward_logger


from stable_baselines.deepq_veg.RLS import RLS
...
class DQN(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
                 ...
                 _init_setup_model=True, policy_kwargs=None, full_tensorboard_log=False, seed=None, save_path=None):
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for _ in range(total_timesteps):
                ...
                if self.num_timesteps % 1000 == 0:
                    ...
                    print("Save dqn model, step = ",self.num_timesteps)
