...
MAX_ROAD_WIDTH = 1.5   # maximum road width [m] # related to RL action space
D_ROAD_W = 0.74  # road width sampling length [m]
DT = 0.3  # time tick [s]
...
class Werling(object):
    ...
    def trajectory_update_RLS(self, dynamic_map, RLS_action):
        ...
        bestpath = fplist[int(RLS_action - 2)][0]
